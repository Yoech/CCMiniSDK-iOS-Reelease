...
#ifndef CCMINISDK_SWIFT_H
#define CCMINISDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CCMiniSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Apple 认证管理类
SWIFT_CLASS("_TtC9CCMiniSDK11CCAppleAuth")
@interface CCAppleAuth : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@class ASAuthorizationController;
@interface CCAppleAuth (SWIFT_EXTENSION(CCMiniSDK)) <ASAuthorizationControllerPresentationContextProviding>
...
@interface CCAppleAuth (SWIFT_EXTENSION(CCMiniSDK)) <ASAuthorizationControllerDelegate>
...
@interface CCGameCenter (SWIFT_EXTENSION(CCMiniSDK)) <GKGameCenterControllerDelegate>
- (void)gameCenterViewControllerDidFinish:(GKGameCenterViewController * _Nonnull)gameCenterViewController;
@end

/// 应用内购买管理类
SWIFT_CLASS("_TtC9CCMiniSDK15CCInAppPurchase")
...
@class SKRequest;
@interface CCInAppPurchase (SWIFT_EXTENSION(CCMiniSDK)) <SKProductsRequestDelegate>
...
@interface CCInAppPurchase (SWIFT_EXTENSION(CCMiniSDK)) <SKPaymentTransactionObserver>
